...
namespace TestProject1
{
    ...
    public class LoginTest
    {
        ...
        {
            Login_Accessor target = new Login_Accessor(); // TODO: 初始化为适当的值
            string logname = "1631320107"; // TODO: 初始化为适当的值
            string loginpass = "zdp199877"; // TODO: 初始化为适当的值
        ...
        {
            Login_Accessor target = new Login_Accessor(); // TODO: 初始化为适当的值
            string logname = "1631320113"; // TODO: 初始化为适当的值
            string loginpass = "wdj1631320113"; // TODO: 初始化为适当的值
            UserInfo expected = null; // TODO: 初始化为适当的值
            UserInfo actual;
            actual = target.checklogin(logname, loginpass);
            Assert.AreEqual(expected, actual);
